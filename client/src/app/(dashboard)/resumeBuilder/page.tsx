...
const App: React.FC = () => {
  ...
  return (
    <div className='flex flex-col bg-[#6b5b95] gap-4 w-full'>
      <div className="p-4 flex gap-4 h-screen w-full">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-1/2 bg-[#EFF3EA] border-black border-2 overflow-y-auto form-style rounded-md ">
